 ...
 *       Filename:  invert.h
 *
 *    Description:  Control loop for Invert tasks power management
 *
 *        Version:  1.0
 *        Created:  20/05/2023
 *       Revision:  none
...
void invert_control(int selected_case, const char *task, int cpu,
                    unsigned long selected_frequency,
                    unsigned long original_frequency)
{
    static const char *task_names[] = {"getrf", "gemm", "trsm", "getri"};
