...
# Group the data by algorithm, matrix_size, and tile_size
groups = df.groupby(['algorithm', 'matrix_size', 'tile_size'])

# Define a list of colors to use for the marker gradient
...
for name, group in groups:
    ...
    plt.savefig(f'{name[0]}_{name[1]}_{name[2]}.png', bbox_inches='tight')
    plt.show()